...
public class Principal {
    ...
    private final String API_KEY = "&apikey=eb5f6b63";
...
//                .peek(e -> System.out.println("filto de avalição N/A " + e))
...
//                                "Data lançameto: " + e.getDataLancamento().format(formatter)
//                ));
        ...
        System.out.println("Quantidadeda: " + est.getCount());
